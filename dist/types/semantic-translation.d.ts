 ...
 */
export declare class SemanticTranslationError extends Error {
    ...
    constructor(message: string, type: TranslationErrorType, details?: {
        sourceParadigm?: ProtocolParadigm;
        targetParadigm?: ProtocolParadigm;
        confidence?: number;
        fallbackAvailable?: boolean;
...
//# sourceMappingURL=semantic-translation.d.ts.map